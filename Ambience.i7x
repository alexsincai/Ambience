...
The first one is "scent". Stating that a room's / region's scent is "foo" will reply with "foo" to the command "smell". A room's scent takes precedence to a region's scent.id

The second one is "sound". Stating that a room's / region's sound is "bar" will reply with "bar" to the command "listen". A room's sound takes precedence to a region's sound.
...
Example: ** Ambient noises and scents.
	...
	*: "Ambience Test" by Reason Optional
	...
	Foo is a room. The description is "Foo is both scented and noisy.". The scent of Foo is "Smells of foo.". The sound of Foo is "Sounds like foo.".

	Bar is north of Foo. The description is "Bar is only noisy.". The sound of Bar is "Sounds like bar.".

	Baz is north of Bar. The description is "Baz is only scented.". The scent of Baz is "Smells of baz.".
	...
	Eggs is north of Xyz. The description is "Eggs contains a noisy clock." A clock is in Eggs. The description is "The clock is a noisy thing.". The sound of the clock is "The clock goes tick-tock.".

	Spam is north of Eggs. The description is "Spam contains a smelly thing." Some cheese is in Spam. The description is "The cheese is a fragrant thing." The scent of the cheese is "The cheese reeks.".

	Ham is north of Spam. The description is "Ham contains both a noisy thing and a fragrant thing.". A bell is in Ham. The description is "The bell is a noisy thing." The sound of the bell is "The bell goes ding!". A flower is in Ham. The description is "The flower is a fragrant thing.". The scent of the flower is "Mmmmm flowers.".

	Snake is north of Ham. The description is "Snake contains a noisy, fragrant thing." An aerosol can is in Snake. The description is "The aerosol can is both fragrant and noisy.". The sound of the aerosol can is "The aerosol can goes fsssst.". The scent of the aerosol can is "The aerosol can emits a chemical odor.".

	Charm is north of Snake. The description is "Charm contains several noisy things.". A widget is in Charm. The description is "A widget that makes sounds.". The sound of the widget is "The widget goes Bang!". A doodad is in Charm. The description is "A doodad that makes sounds." The sound of the doodad is "The doodad goes Pop!".

	Strange is north of Charm. The description is "Strange contains several fragrant things.". A thingie is in Strange. The description is "A thingie that smells.". The scent of the thingie is "The thingie smells like stuff.". A gizmo is in Strange. The description is "A gizmo that smells like things." The scent of the gizmo is "The gizmo smells like SCIENCE!".
	...
	Test me with "listen / smell / n / listen / smell / n / listen / smell / n / listen / smell / n / listen / smell / n / smell / listen / n / smell / listen / n / smell / listen / n / smell / listen / n / smell / listen". 